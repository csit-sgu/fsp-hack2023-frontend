  ...
  <div class="flex items-center justify-center h-screen relative isolate px-6 pt-14 lg:px-8 md:text-center">
    <form class="w-full max-w-lg">
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full py-3">
          ...
          <input
            ...
            id="grid-first-name" type="text" placeholder="Имя">
        ...
        <div class="w-full py-3">
          ...
          <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            id="grid-last-name" type="text" placeholder="Отчество (необязательно)">
        </div>
      </div>
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full py-3">
      ...
      <div class="flex flex-wrap -mx-3 mb-4">
        <div class="w-full md:w-1/3 pr-3 md:pr-0 mb-3 md:mb-0">
        ...
        <div class="w-full md:w-1/3 px-0 md:px-0 mb-3 md:mb-0">
        ...
        <div class="w-full md:w-1/3 pl-3 md:pl-0 mb-3 md:mb-0">
